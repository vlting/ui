...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Sidebar 01', href: '/docs/blocks/sidebar-01' },
      { label: 'Sidebar 02', href: '/docs/blocks/sidebar-02' },
      { label: 'Sidebar 03', href: '/docs/blocks/sidebar-03' },
      { label: 'Sidebar 04', href: '/docs/blocks/sidebar-04' },
      { label: 'Sidebar 05', href: '/docs/blocks/sidebar-05' },
      { label: 'Sidebar 06', href: '/docs/blocks/sidebar-06' },
      { label: 'Sidebar 07', href: '/docs/blocks/sidebar-07' },
      { label: 'Sidebar 08', href: '/docs/blocks/sidebar-08' },
      { label: 'Sidebar 09', href: '/docs/blocks/sidebar-09' },
      { label: 'Sidebar 10', href: '/docs/blocks/sidebar-10' },
      { label: 'Sidebar 11', href: '/docs/blocks/sidebar-11' },
      { label: 'Sidebar 12', href: '/docs/blocks/sidebar-12' },
      { label: 'Sidebar 13', href: '/docs/blocks/sidebar-13' },
      { label: 'Sidebar 14', href: '/docs/blocks/sidebar-14' },
      { label: 'Sidebar 15', href: '/docs/blocks/sidebar-15' },
      { label: 'Sidebar 16', href: '/docs/blocks/sidebar-16' },
