export function HomePage() {
  return (
    <div>
      ...
      <p style={{ fontSize: 16, color: '#666', marginBottom: 24, maxWidth: 600, lineHeight: 1.6 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 16 }}>
        {[
          { label: 'Styling & Tokens', desc: 'Color scales, spacing, typography', href: '/styling' },
          { label: 'Primitives', desc: 'Box, Text, Stack, Badge, etc.', href: '/primitives' },
          ...
          { label: 'Data Display', desc: 'Table, Accordion, Chart, etc.', href: '/data-display' },
          { label: 'Navigation', desc: 'Tabs, Breadcrumb, Menu, etc.', href: '/navigation' },
