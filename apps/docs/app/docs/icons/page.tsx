    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
      ...
      <div>
        ...
        <p style={{ color: 'var(--color-muted-foreground)', fontSize: 16, lineHeight: 1.6 }}>
          Browse and search 3,229 Remix Icons. Click any icon to copy its import statement.
        </p>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <p style={{ color: 'var(--color-muted-foreground)', fontSize: 14, lineHeight: 1.6 }}>
          Import icons directly by name. Each icon has <code>Line</code> and <code>Fill</code> variants.
        </p>
        <CodeBlock
...
<RiHomeFill size={20} color="$blue10" />`}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <p style={{ color: 'var(--color-muted-foreground)', fontSize: 14, lineHeight: 1.6 }}>
          Use <code>DynamicIcon</code> for lazy-loaded icons by name string. Useful when the icon name
          comes from data.
        </p>
        <CodeBlock
