    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.demo}>
          <Box
            css={{ width: 80, height: 80, backgroundColor: '$primary4', borderRadius: 8 }}
          />
          <Box
            css={{ width: 80, height: 80, backgroundColor: '$primary6', borderRadius: 8 }}
          />
          <Box
            css={{ width: 80, height: 80, backgroundColor: '$primary8', borderRadius: 8 }}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Row css={{ gap: 8 }}>
          <Box
            css={{ width: 50, height: 50, backgroundColor: '$green4', borderRadius: 4 }}
          />
          <Box
            css={{ width: 50, height: 50, backgroundColor: '$green5', borderRadius: 4 }}
          />
          <Box
            css={{ width: 50, height: 50, backgroundColor: '$green6', borderRadius: 4 }}
          />
          <Box
            css={{ width: 50, height: 50, backgroundColor: '$green7', borderRadius: 4 }}
          />
        </Row>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Column css={{ gap: 8 }}>
          <Box
            css={{ width: 200, height: 32, backgroundColor: '$blue4', borderRadius: 4 }}
          />
          <Box
            css={{ width: 200, height: 32, backgroundColor: '$blue5', borderRadius: 4 }}
          />
          <Box
            css={{ width: 200, height: 32, backgroundColor: '$blue6', borderRadius: 4 }}
          />
        </Column>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Grid css={{ gap: 8 }} columns={3}>
          {Array.from({ length: 6 }, (_, i) => (
            <Box
              key={i}
              css={{ height: 50, backgroundColor: '$purple4', borderRadius: 4 }}
            />
          ))}
        </Grid>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Row css={{ height: 40, backgroundColor: '$color3', borderRadius: 4 }}>
          <Box
            css={{ width: 40, height: 40, backgroundColor: '$primary6', borderRadius: 4 }}
          />
          <Spacer />
          <Box
            css={{ width: 40, height: 40, backgroundColor: '$primary6', borderRadius: 4 }}
        ...
        <Row css={{ gap: 4, marginTop: 8 }}>
          <Box
            css={{ width: 20, height: 20, backgroundColor: '$blue5', borderRadius: 2 }}
          />
          <Spacer size="xs" />
          <Box
            css={{ width: 20, height: 20, backgroundColor: '$blue5', borderRadius: 2 }}
