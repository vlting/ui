    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.note}>
          Token references ($primary1-12, $red1-12, etc.) resolve at runtime via the style resolver.
        </Text>
...
const styles = StyleSheet.create({
  ...
  paletteLabel: { fontSize: 13, fontWeight: '600', marginBottom: 4, textTransform: 'capitalize' },
