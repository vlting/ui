...
export const THEME_PRESET_FLAT: CreateThemeOptions = {
  ...
  shadows: {
    light: {
      sm: { boxShadow: '0 4px 0 hsla(290, 15%, 25%, 0.15)', color: 'hsla(290, 15%, 25%, 0.15)' },
      md: { boxShadow: '0 6px 0 hsla(290, 15%, 25%, 0.15)', color: 'hsla(290, 15%, 25%, 0.15)' },
      lg: { boxShadow: '0 10px 0 hsla(290, 15%, 25%, 0.15)', color: 'hsla(290, 15%, 25%, 0.15)' },
      xl: { boxShadow: '0 14px 0 hsla(290, 15%, 25%, 0.15)', color: 'hsla(290, 15%, 25%, 0.15)' },
      '2xl': { boxShadow: '0 20px 0 hsla(290, 15%, 25%, 0.15)', color: 'hsla(290, 15%, 25%, 0.15)' },
    },
    dark: {
      sm: { boxShadow: '0 4px 0 hsla(290, 10%, 10%, 0.3)', color: 'hsla(290, 10%, 10%, 0.3)' },
      md: { boxShadow: '0 6px 0 hsla(290, 10%, 10%, 0.3)', color: 'hsla(290, 10%, 10%, 0.3)' },
      lg: { boxShadow: '0 10px 0 hsla(290, 10%, 10%, 0.3)', color: 'hsla(290, 10%, 10%, 0.3)' },
      xl: { boxShadow: '0 14px 0 hsla(290, 10%, 10%, 0.3)', color: 'hsla(290, 10%, 10%, 0.3)' },
      '2xl': { boxShadow: '0 20px 0 hsla(290, 10%, 10%, 0.3)', color: 'hsla(290, 10%, 10%, 0.3)' },
    },
  },
