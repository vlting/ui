# Component Contract — MapPin

## 1. Public API

### Base Props

`MapPin` is implemented as a Tamagui `styled(YStack)` and therefore accepts all Tamagui / React Native `View` props, including:
...
idle, hover, focus, active (pressed), selected.
...
- Removing a named static sub-component (e.g., `MapPin.Item`).
