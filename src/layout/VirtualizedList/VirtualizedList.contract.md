# Component Contract — VirtualizedList

## 1. Public API

### Base Props

`VirtualizedList` is implemented as a Tamagui `styled(YStack)` and therefore accepts all Tamagui / React Native `View` props, including:
...
- Removing a named static sub-component (e.g., `VirtualizedList.Item`).
