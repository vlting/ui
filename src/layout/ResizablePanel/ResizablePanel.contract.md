# Component Contract — ResizablePanel

## 1. Public API

### Base Props

`ResizablePanel` is implemented as a Tamagui `styled(YStack)` and therefore accepts all Tamagui / React Native `View` props, including:
...
- Removing a named static sub-component (e.g., `ResizablePanel.Item`).
