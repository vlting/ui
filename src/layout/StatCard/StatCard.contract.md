# Component Contract — StatCard

## 1. Public API

### Base Props

`StatCard` is implemented as a Tamagui `styled(YStack)` and therefore accepts all Tamagui / React Native `View` props, including:
...
states using interactive color tokens.
...
- Removing a named static sub-component (e.g., `StatCard.Item`).
