...
export const poshBrand: BrandDefinition = {
  ...
  shadows: {
    ...
    dark: {
      sm: { boxShadow: '0 2px 8px rgba(0,0,0,0.10)', color: 'rgba(0,0,0,0.10)', offset: { width: 0, height: 2 }, radius: 8, opacity: 0.10 },
      md: { boxShadow: '0 4px 16px rgba(0,0,0,0.15)', color: 'rgba(0,0,0,0.15)', offset: { width: 0, height: 4 }, radius: 16, opacity: 0.15 },
      lg: { boxShadow: '0 8px 32px rgba(0,0,0,0.20)', color: 'rgba(0,0,0,0.20)', offset: { width: 0, height: 8 }, radius: 32, opacity: 0.20 },
  ...
  fonts: {
    heading: {
      ...
      letterSpacing: { 1: 0.5, 2: 0.3, 3: 0.2, 4: 0.1, 5: 0, 6: -0.1, 7: -0.2, 8: -0.3, true: 0 },
    },
    body: {
