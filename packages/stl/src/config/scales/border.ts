  ...
  const { aliasMap, cssAliases } = getAliasMap(
    {
      ...
      neutral: {
        borderBlockStartColor: 'topNeutralColorBase',
        borderBlockEndColor: 'bottomNeutralColorBase',
        borderInlineStartColor: 'leftNeutralColorBase',
        borderInlineEndColor: 'rightNeutralColorBase',
        borderBlockStartWidth: 'topWidthDefault',
        borderBlockEndWidth: 'bottomWidthDefault',
        borderInlineStartWidth: 'leftWidthDefault',
        borderInlineEndWidth: 'rightWidthDefault',
      ...
      neutralMin: {
        borderBlockStartColor: 'topNeutralColorMin',
        borderBlockEndColor: 'bottomNeutralColorMin',
        borderInlineStartColor: 'leftNeutralColorMin',
        borderInlineEndColor: 'rightNeutralColorMin',
        borderBlockStartWidth: 'topWidthDefault',
        borderBlockEndWidth: 'bottomWidthDefault',
        borderInlineStartWidth: 'leftWidthDefault',
        borderInlineEndWidth: 'rightWidthDefault',
      ...
      neutralMax: {
        borderBlockStartColor: 'topNeutralColorMax',
        borderBlockEndColor: 'bottomNeutralColorMax',
        borderInlineStartColor: 'leftNeutralColorMax',
        borderInlineEndColor: 'rightNeutralColorMax',
        borderBlockStartWidth: 'topWidthDefault',
        borderBlockEndWidth: 'bottomWidthDefault',
        borderInlineStartWidth: 'leftWidthDefault',
        borderInlineEndWidth: 'rightWidthDefault',
