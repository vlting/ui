...
export function getColor(hash: CharHash) {
  ...
  const lightScale = {
    ...
    backgroundHover: { ...hash.var, value: lightPalette.background1.ref },
    backgroundPress: { ...hash.var, value: lightPalette.background2.ref },
    color: { ...hash.var, value: lightPalette.neutral12.ref },
    colorHover: { ...hash.var, value: lightPalette.neutral12.ref },
    colorPress: { ...hash.var, value: lightPalette.neutral10.ref },
    borderColor: { ...hash.var, value: lightPalette.neutral4.ref },
    borderColorHover: { ...hash.var, value: lightPalette.neutral5.ref },
    borderColorPress: { ...hash.var, value: lightPalette.neutral3.ref },
  ...
  const darkVars = {
    ...
    background: { ...lightScale.background, value: lightScale.background12.ref },
    backgroundHover: { ...lightScale.backgroundHover, value: lightScale.background11.ref },
    backgroundPress: { ...lightScale.backgroundPress, value: lightScale.background10.ref },
    color: { ...lightScale.color, value: lightScale.max.ref },
    colorHover: { ...lightScale.colorHover, value: lightScale.max.ref },
    colorPress: { ...lightScale.colorPress, value: lightScale.neutral2.ref },
    borderColor: { ...lightScale.borderColor, value: lightScale.neutral8.ref },
    borderColorHover: { ...lightScale.borderColorHover, value: lightScale.neutral7.ref },
    borderColorPress: { ...lightScale.borderColorPress, value: lightScale.neutral9.ref },
