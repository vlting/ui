...
import type { Keyframes, ThemeScale } from './scales.models'
import {
  getAliasMap,
  getCssMapFromVars,
  getPropsFromCssMap,
...
export function getAnimation(hash: CharHash, keyframeHash: CharHash) {
  ...
  const vars = {
    ...
    // Opacity tokens
    disabledOpacity: { ...hash.var, value: '0.5' },
    fullOpacity: { ...hash.var, value: '1' },
  } as const
...
export const opacities = { disabledOpacity: true, fullOpacity: true } as const
