...
export const mappedProps = {
  ...
  borderBlockStart: getPropMapper(
    'borderBlockStartColor',
    'borderBlockStartStyle',
    'borderBlockStartWidth',
  ),
  borderBlockEnd: getPropMapper(
    'borderBlockEndColor',
    'borderBlockEndStyle',
    'borderBlockEndWidth',
  ),
  borderInlineStart: getPropMapper(
    'borderInlineStartColor',
    'borderInlineStartStyle',
    'borderInlineStartWidth',
  ),
  borderInlineEnd: getPropMapper(
    'borderInlineEndColor',
    'borderInlineEndStyle',
    'borderInlineEndWidth',
  ),
...
export const valueMappers = {
  gridTemplate: (value: string) => {
    ...
    if (hasLineBreaks)
      throw new Error(
        'We do not currently support areas via this property; please use `gridArea` for that.',
      )
    return value
  },
} as const
...
type MaybeCustomString<
  T,
  K extends MapKey | ComplexShorthandProp,
