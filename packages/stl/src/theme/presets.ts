 ...
 *
 * Primary accent: hue 205, saturation 90 (teal-shifted blue)
 * Secondary accent: hue 280, saturation 70 (purple)
 * Neutral: hue 215, saturation 0 (true achromatic gray)
 */
export const THEME_PRESET_DEFAULT: CreateThemeOptions = {
  primary: { hue: 205, saturation: 90 },
  secondary: { hue: 280, saturation: 70 },
