...
const AlertRoot = styled('div', {
  ...
  compoundVariants: [
    { when: { variant: 'outlineMin', theme: 'primary' }, stl: { border: '$primaryMin', borderBlockStartWidth: '$widthMin', borderBlockEndWidth: '$widthMin', borderInlineStartWidth: '$widthMin', borderInlineEndWidth: '$widthMin' } },
    { when: { variant: 'outlineMin', theme: 'secondary' }, stl: { border: '$secondaryMin', borderBlockStartWidth: '$widthMin', borderBlockEndWidth: '$widthMin', borderInlineStartWidth: '$widthMin', borderInlineEndWidth: '$widthMin' } },
    { when: { variant: 'outlineMin', theme: 'neutral' }, stl: { border: '$neutralMin', borderBlockStartWidth: '$widthMin', borderBlockEndWidth: '$widthMin', borderInlineStartWidth: '$widthMin', borderInlineEndWidth: '$widthMin' } },
    { when: { variant: 'outlineMin', theme: 'success' }, stl: { border: '$successMin', borderBlockStartWidth: '$widthMin', borderBlockEndWidth: '$widthMin', borderInlineStartWidth: '$widthMin', borderInlineEndWidth: '$widthMin' } },
    { when: { variant: 'outlineMin', theme: 'warning' }, stl: { border: '$warningMin', borderBlockStartWidth: '$widthMin', borderBlockEndWidth: '$widthMin', borderInlineStartWidth: '$widthMin', borderInlineEndWidth: '$widthMin' } },
    { when: { variant: 'outlineMin', theme: 'error' }, stl: { border: '$errorMin', borderBlockStartWidth: '$widthMin', borderBlockEndWidth: '$widthMin', borderInlineStartWidth: '$widthMin', borderInlineEndWidth: '$widthMin' } },
    { when: { variant: 'outlineMin', theme: 'info' }, stl: { border: '$infoMin', borderBlockStartWidth: '$widthMin', borderBlockEndWidth: '$widthMin', borderInlineStartWidth: '$widthMin', borderInlineEndWidth: '$widthMin' } },
